...
struct L10n {
  private static let strings: [String: [AppLanguage: String]] = [
    ...
    "plugin.fileSearch.searchFiles": [.zhHans: "搜索文件...", .en: "Search files..."],
    "plugin.fileSearch.inputFileName": [.zhHans: "输入文件名进行搜索", .en: "Enter file name to search"],
    "plugin.fileSearch.openFile": [.zhHans: "打开文件...", .en: "Open file..."],
    "plugin.fileSearch.findFile": [.zhHans: "查找文件...", .en: "Find file..."],
